...
const ChevronUpDown = ({ sorting }: { sorting: false | SortDirection }) => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="icon icon-tabler icons-tabler-filled icon-tabler-caret-up-down"
    >
      ...
      <path
        ...
        fill={isDesc ? "var(--primary)" : "currentColor"}
      />
      <path
        ...
        fill={isAsc ? "var(--primary)" : "currentColor"}
      />
    </svg>
  );
};
